...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
        ...
        if (isset($product_option) && $product_option) {
          ...
          $this->pcop_set($product_option_id, $product_option);
          $this->pcop_reinsert_product_option($product_option_id);
        }
	...
	public function getProductAttributes($product_id) {
        ...
        private function pcop_checkTables() {
        ...
        private function pcop_set($product_option_id, $product_option) {
        ...
        private function pcop_reinsert_product_option($product_option_id) {
